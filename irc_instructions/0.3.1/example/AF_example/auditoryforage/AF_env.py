...
class AuditoryForaging(Env):
    ...
    def __init__(self,
        *,
        ...
        self.prob_01 = D_ENV_SPEC['experiment']['prob_01']
        self.no_signal_nodes = D_ENV_SPEC['experiment']['no_signal_nodes']
        self.no_penalty_nodes = D_ENV_SPEC['experiment']['no_penalty_nodes']
        self.no_ITI_nodes =  D_ENV_SPEC['experiment']['no_ITI_nodes']
        self.no_nodes = 1 + self.no_signal_nodes + self.no_penalty_nodes + self.no_ITI_nodes
        ...
        self.lick_cost = D_ENV_SPEC['agent']['lick_cost']
        self.food_reward = D_ENV_SPEC['agent']['food_reward']
        # self.high_attention_cost = self.spec.agent.high_attention_cost
        self.attention_cost_coeff = D_ENV_SPEC['agent']['attention_cost_coeff']
        self.attention_cost_temp = D_ENV_SPEC['agent']['attention_cost_temp']
        self.no_attention_modes = D_ENV_SPEC['agent']['no_attention_modes']
        self.obs_certainity_possible = 1/(2*(self.no_attention_modes-1)) * np.arange(self.no_attention_modes) + 0.5 
        # self.attention_cost = np.array([0,self.high_attention_cost])
        self.penalty_cost = D_ENV_SPEC['agent']['penalty_cost']
        self.iti_cost = D_ENV_SPEC['agent']['iti_cost']
