...
exps_list = {0: (25, 10), 2: (38, 15), 3: (50, 20), 4: (63, 25), 6: (13, 5), 7: (13, .75), 8: (13, 1), 9: (13, .65), 10: (13, .5), 11: (.05, .25), 12: (.06, .25), 13: (.07, .25), 14: (.08, .25)}

selected_exps = exps_list.keys()
selected_exps = [0,2,3,4,6, 11, 12, 13, 14]
