...
class ParticleFilter():
    ...
    def save_filter_output(self, PF_IO, end_index):
        ...
        store_folder = 'store/filters/PF_agent/' + self.true_params_folder_name
...
class PF_results_analyzer():
    ...
    def plot_posterior(self):    
        ...
        for variable in latent_variables_list:
            ...
            if variable == 'agent':
                agent_ranked = self.PF_IO['output']['sorted_results'][variable]['agent_ranked']
                plt.stem(agent_ranked, PF_posterior)
            else:
