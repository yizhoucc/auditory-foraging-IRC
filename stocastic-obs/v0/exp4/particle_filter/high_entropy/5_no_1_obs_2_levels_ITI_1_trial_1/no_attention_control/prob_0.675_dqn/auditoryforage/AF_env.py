...
class AuditoryForaging(Env):
    ...
    def __init__(self,
        *,
        ...
        # changed for fixed attention
        # self.obs_certainity_possible = 0.4/(self.no_attention_modes-1) * np.arange(self.no_attention_modes) + 0.5 
        self.obs_certainity_possible = np.arange(self.no_attention_modes) + 0.675 
