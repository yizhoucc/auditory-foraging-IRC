...
env_param = [-3.0, 50.0, .08, .25, -5000, 0] #CHANGE
true_params_folder_name = 'low_en_2_tn_2_fr_50_ac_0.08_0.25/' #CHANGE
file_name = './store/exp_data/exp_data.pkl' #CHANGE
reward_level = 'low' #CHANGE
episode_no = 2 #CHANGE
trial_no = 2 #CHANGE
...
env_param_list.append([-3.0, 50.0, .08, .25, -5000, 0]) #CHANGE
env_param_list.append([-3.0, 350.0, .08, .25, -5000, 0]) #CHANGE

num_epochs = 50 #CHANGE
