...
class AuditoryForaging(Env):
    ...
    def __init__(self,
        *,
        ...
        self.obs_certainity_possible = 0.2/(self.no_attention_modes-1) * np.arange(self.no_attention_modes) + 0.5 
        ...
        self.action_space = MultiDiscrete([2, self.no_attention_modes])
    ...
    def find_reward(self, lick_choice, attention_choice):
        ...
        # Manually changed attention cost
        self.attention_cost = np.array([-0.05329726, -0.07951017, -0.17861524])
