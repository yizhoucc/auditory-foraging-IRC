    ...
    def setup(self, config):
        ...
        class CustomNetwork(nn.Module):
            ...
            def __init__(
                ...
                # )
                self.policy_net = nn.Sequential(
                    nn.Linear(feature_dim, 20), nn.Tanh(), nn.Linear(20, 20), nn.Tanh(), nn.Linear(20, 2)
                )
            ...
            def forward_actor(self, features: th.Tensor) -> th.Tensor:
                ...
                mid_features =  self.policy_net(features)
                final_features = torch.stack((-mid_features[:, 0], mid_features[:, 0], -mid_features[:, 1], mid_features[:, 1]), dim=1)
