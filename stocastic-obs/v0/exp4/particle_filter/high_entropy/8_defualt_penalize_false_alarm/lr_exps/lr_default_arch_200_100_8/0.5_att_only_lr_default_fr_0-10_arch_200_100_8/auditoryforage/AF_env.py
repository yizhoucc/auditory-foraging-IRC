...
class AuditoryForaging(Env):
    ...
    def __init__(self,
        *,
        ...
        # lokesh experimenting constant attention
        # self.obs_certainity_possible = 0.25/(self.no_attention_modes-1) * np.arange(self.no_attention_modes) + 0.5 
        self.obs_certainity_possible = 0/(self.no_attention_modes-1) * np.arange(self.no_attention_modes) + 0.5 
