...
if len(sys.argv) < 7:
    print("ERROR! Correct usage is python train.py <food_reward> <att_coeff> <att_temp> <penalty_cost> <num_epochs> <seed_value>")
    sys.exit(1)
else:
...
env_param = [0, food_reward, att_coeff, att_temp, penalty_cost, 0]
print("########################################################################")
