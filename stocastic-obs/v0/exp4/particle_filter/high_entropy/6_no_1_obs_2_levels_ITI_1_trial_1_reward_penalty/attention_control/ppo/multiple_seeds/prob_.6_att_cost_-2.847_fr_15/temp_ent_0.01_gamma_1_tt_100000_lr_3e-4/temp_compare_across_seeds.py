                ...
                for penalty_cost in penalty_cost_list:
                    for iti_cost in iti_cost_list:
                        ...
                        for seed in seed_list:
                            ...
                            print("************************************************************************")
                            print("########################################################################")
                            print(f"\n \n Seed list was  {seed_list}\n \n ")
                            print(f"\n \n Seed value is  {seed}\n \n ")
                            print(f"\n \n Training going on for env_param {env_param} and {num_epochs} epochs\n \n ")
                            print("########################################################################")
                            print("************************************************************************")
...
file_name = folder_name + f'{no_episodes}_trials_evaluation_across_penalty_#seeds_{len(seed_list)}_#epochs_{num_epochs}.pkl'
