...
print("=== Starting: notebooks/varying p1 no peroid.ipynb ===")
...
# --- Cell 1 ---
modelname = 'varyp1_v2'
p1list=[np.array([.6, .8]),np.array([.65, .8]),np.array([.7, .8])]
...
print("=== Done: notebooks/varying p1 no peroid.ipynb ===")
