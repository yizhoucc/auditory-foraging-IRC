...
print("=== Starting: notebooks/vary att cost.ipynb ===")
...
from irc_gym.irc.model import FuncBeliefModel
from stable_baselines3 import PPO
from auditoryforage.AF_env import AFVaryAttention as AFtask


# --- Cell 1 ---
modelname = 'vary_att_v1'
...
print("=== Done: notebooks/vary att cost.ipynb ===")
