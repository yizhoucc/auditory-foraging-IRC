...
print("=== Starting: notebooks/vary node p norate.ipynb ===")
...
for iepoch in range(0, n_epoch):
    ...
    for food_reward_idx in range(len(food_reward_list)):     
        ...
        for inode, node in enumerate(node_list):
            ...
            print(food_reward_idx,inode, grid.shape)
...
print("=== Done: notebooks/vary node p norate.ipynb ===")
