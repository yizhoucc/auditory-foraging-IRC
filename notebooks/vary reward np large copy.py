...
print("=== Starting: notebooks/vary reward np large copy.ipynb ===")
...
for iepoch in range(0,n_epoch):
    ...
    for i, food_reward_idx in enumerate(use_reward):
        ...
        sequences = sorted_list_of_lists[-555:] # Choosing what range of trial lengths to use. Could modify to be more consistent.
        print(len(sorted_list_of_lists))
...
print("=== Done: notebooks/vary reward np large copy.ipynb ===")
