...
print("=== Starting: notebooks/vary p1 p v2.ipynb ===")
...
# --- Cell 3 ---
modelname = 'varyp1pv2'
plist = [np.array([.5, .7]),np.array([.51,.7]),np.array([.52, .7]),np.array([.53, .7]), np.array([.6, .7])]
...
print("=== Done: notebooks/vary p1 p v2.ipynb ===")
