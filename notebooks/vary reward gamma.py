...
print("=== Starting: notebooks/vary reward gamma.ipynb ===")
...
# --- Cell 1 ---
modelname = 'vary_reward_norateV1'
...
# --- Cell 2 ---
modelname = 'vary_reward_norateV2'
...
# for iepoch in range(22,44):
    ...
    df = pd.DataFrame(results)
    print(f'total reward: {sum(np.concatenate(df.rewards.to_numpy()))}')
    hit_reaction_plot(df, 'notimediv')



print("=== Done: notebooks/vary reward gamma.ipynb ===")
