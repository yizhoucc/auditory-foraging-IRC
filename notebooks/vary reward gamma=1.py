...
print("=== Starting: notebooks/vary reward gamma=1.ipynb ===")
...
# --- Cell 1 ---
modelname = 'vary_reward_gamma1_V1'
...
# --- Cell 2 ---
modelname = 'vary_reward_gamma1_V2'
...
# --- Cell 3 ---
# check should after singal duration
modelname = 'vary_reward_gamma1_V3'
        ...
        for p1p2 in plist:
            ...
            if iepoch == 0:
                model = PPO('MlpPolicy', taskbelief, verbose=0, device='cpu',
                            clip_range=0.1, ent_coef=0.01, gamma=1)
            else:
                previous_model = f'seed{seed}_{modelname}_n{node}_p{p1p2}_ep{iepoch-1}'
                model = PPO.load(f'ycstore/{previous_model}', env=taskbelief,gamma=1)
            ...
            model = PPO.load(f'ycstore/{thismodel}', env=taskbelief, gamma=1) # test load
...
print("=== Done: notebooks/vary reward gamma=1.ipynb ===")
